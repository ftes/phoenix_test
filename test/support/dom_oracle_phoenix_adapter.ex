defmodule PhoenixTest.DomOracle.PhoenixAdapter do
  @moduledoc false
  ...
  defp flatten_value_entries(key, value) when is_list(value) do
    Enum.map(value, &[key, ParityCore.normalize_value(&1)])
  end

  defp flatten_value_entries(key, value), do: [[key, ParityCore.normalize_value(value)]]
end
